...
if (isset($_POST["name"]) && isset($_POST["type"]) && isset($_POST["price"]) && isset($_POST["quantity"]) && isset($_POST["exp_date"]) && isset($_POST["man_date"])) {
    $name = $_POST["name"];
    $type = $_POST["type"];
    $price = $_POST["price"];
    ...
    $sql = "INSERT INTO inventory (name, type, price, quantity, exp_date, man_date) 
            VALUES ('$name',' $type' ,'$price', '$quantity', '$exp_date', '$man_date')";
...
<body>
    ...
    <div class="container">
        <div class="content">
            ...
            <div class="text-sci">
                <h2>Welcome Back <br>To the Inventory!<span></span></h2>
        ...
        <div class="logreg-box">
            <div class="form-box login">
                <form action="#" method="POST">
                    ...
                    <a href="display.php"><button type="submit" class="btn btn-primary btn-lg">Submit</button></a>
