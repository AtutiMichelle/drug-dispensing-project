...
if (isset($_POST['email']) && isset($_POST['password'])) {
    ...
    $select = mysqli_query($conn, "SELECT id, name, password FROM pharmacy WHERE email='$email' AND password='$password'");
        ...
        <div class="form-box login">
            <form action="#" method="POST">
                ...
                <div class="login-register">
                    <p>Dont Have an Account? <a href="regPharmacy.php" class="register-link">Sign Up</a></p>
                </div>
            </form>
        </div>
        </div>
