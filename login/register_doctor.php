...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    if (isset($_POST["license_no"]) && isset($_POST["SSN"]) && isset($_POST["fname"]) && isset($_POST["lname"]) && isset($_POST["number"]) && isset($_POST["email"]) && isset($_POST["specialty"]) && isset($_POST["hospital"]) && isset($_POST["password"])) {
        ...
        $sql = "INSERT INTO doctor (license_no, SSN, fname, lname, number, email, speciality, hospital, password) 
                VALUES ('$license_no', '$SSN', '$fname', '$lname', '$number', '$email', '$specialty', '$hospital', '$password')";
...
<div class="background" style="background=url(../images/silde3.jpg)"></div>
 <div class="container">
    ...
    <div class="text-sci">
        <h2>Welcome Back <br>Register here <span></span></h2>
    ...
    <div class="logreg-box">
        ...
        <form action="register_doctor.php" method="POST">
                ...
                <div class="login-register">
                    <p>Already Have an Account? <a href="doctor_login.php" class="register-link">Sign In</a></p>
                </div>
            </form>
        </div>
        </div>
