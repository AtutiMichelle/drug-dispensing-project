...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    if (isset($_POST["name"]) && isset($_POST["email"]) && isset($_POST["number"]) && isset($_POST["location"]) && isset($_POST["password"])) {
        ...
        $sql = "INSERT INTO pharmacy (name, email, number, location, password) 
...
<body>
    ...
    <div class="container">
        <div class="content">
            ...
            <div class="text-sci">
                <h2>Welcome Back </h2>
                <p>Proceed to your Right to Register as a Pharmacy</p>
        ...
        <div class="logreg-box">
            <div class="form-box login">
                <form action="regPharmacy.php" method="POST">
                    ...
                    <a href="pharmacyLogin.php"><button type="submit" class="btn">Submit</button></a>

                    <div class="login-register">
                        <p>Already Have an Account? <a href="pharmacyLogin.php" class="register-link">Sign In</a></p>
                    </div>
                </form>
            </div>
        </div>
